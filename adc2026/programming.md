...
- 2025-06-04 [プログラム実行結果の提出について](#プログラム実行結果の提出について-) を更新しました。
...
![お試しマインスイーパー画面](images/otameshi_borad.PNG)
...
- プログラム競技の結果を記載する Excel ファイルをダウンロードいただき、実行結果を記載いただきまして、das2025support”at”sig-sldm.org より、ADC 事務局あてご連絡をいただければと思います。（”at”は@に変換してください）。
...
## 問い合わせ先
サイトがうまく動作しない、データが足りない、などお困りの場合やその他ご不明点等がございましたらお気軽に das2025support”at”sig-sldm.org より、ADC 事務局あてご連絡をいただければと思います。（”at”は@に変換してください）。事務局メンバーより返信させていただきます。どうぞよろしくお願いいたします。
