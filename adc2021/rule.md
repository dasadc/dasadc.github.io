# アルゴリズムデザインコンテスト2021（ADC2021）ルール説明
...
- 当日その場で公開する問題以外に、会期前に事前公開する長時間用の問題を用意
- 回答の速さについてもポイントに反映する予定
...
2. 盤面平面の最大サイズは昨年度の72x72マスから拡張の予定（決まり次第掲載予定）
...
- 参加チームが問題を自作して提供可能（事前公開問題、当日公開問題の双方の予定）
