...
このサイトでは、[DAシンポジウム2022](http://www.sig-sldm.org/das/)で行うアルゴリズムデザインコンテスト(ADC)の参加者向け解説、およびコンテスト内にて使用する「自動運営システム」についての解説を行います。

## 当日参加企画について

DAシンポジウム2022参加者は当日参加が可能です。奮ってご参加ください。[当日参加企画ページ](today2022.md)
...
[ADC自動運営システムの最新情報がこちらにあります。](https://github.com/dasadc/adc2019/blob/master/README.md#news)

- 2022-04-01 初版を公開しました
...
2022年は、2021年と同様の「配置配線パズル」を競技内容とします。
...
- ADC2021で新しく採用した事前公開問題は今年も実施します。
  - その上で、事前公開問題と当日実施問題ので出題される問題サイズ・問題数の構成を変更する予定です。
- 最初に正答したチームに加点するルールは今年も採用します。
...
- [ADC2021競技結果](docs/ADC2021_results.pdf)
- [ADC2021問題&回答例](docs/QA2021.zip)
